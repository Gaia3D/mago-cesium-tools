...
export class MagoFluid {
    ...
    async initWaterSimulation(options) {
        ...
        const imageBasedLighting = new Cesium.ImageBasedLighting({
            sphericalHarmonicCoefficients: coefficients, specularEnvironmentMaps: environmentMapURL,
        });
        ...
        const gltf = await Cesium.Model.fromGltfAsync({
            ...
            shadows: Cesium.ShadowMode.RECEIVE_ONLY, //imageBasedLighting: imageBasedLighting,
        });
