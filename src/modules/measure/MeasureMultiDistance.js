    ...
    on = (isContinue = false) => {
        ...
        const mouseLeftClickHandler = (event) => {
            ...
            if (this.cartesians.length > 0) {
                const lastCartesian = this.cartesians[this.cartesians.length -
                1];
                console.log(lastCartesian, pickedEllipsoidPosition);
                if (Cesium.Cartesian3.equals(lastCartesian,
                    pickedEllipsoidPosition)) {
            ...
            if (this.pointEntities.length > 0) {
                ...
                const center = Cesium.Cartesian3.add(lastCartesian,
                    pickedEllipsoidPosition, new Cesium.Cartesian3());
